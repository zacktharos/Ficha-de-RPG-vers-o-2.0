...
import type { Ficha, InventarioItem, Magia, DiceRoll, Vantagem, Desvantagem, Raca, NivelInfo } from './types';
import { FICHA_MATRIZ_ID, RGP_FICHAS_KEY, RPG_CURRENT_FICHA_ID_KEY, vantagensData, desvantagensData, racasData, nivelData } from './constants';
import { useCharacterSheet } from './hooks/useCharacterSheet';
import { useDynamicStyles } from './hooks/useDynamicStyles';
import { generateNpcData, distributePoints } from './utils/generator';
import type { Atributo, Arquétipo } from './utils/generator';
    ...
    const renderArchetypeSelection = (onSelect: (archetype: Arquétipo) => void, title: string) => (
         <div>
            ...
            <div className="grid grid-cols-1 gap-2">
                {Object.keys(distributePoints).map(arch => (
                    <button
                        key={arch}
